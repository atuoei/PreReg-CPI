...
class Model(nn.Module):
    def __init__(self, embedding_dim=640, rnn_dim=128, hidden_dim=256, graph_dim=256, dropout_rate=0.3, 
                     alpha=0.2, n_heads=8, graph_input_dim=78, rnn_layers=2, n_attentions=1, 
